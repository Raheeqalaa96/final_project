			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="carousel-item item2">
						<div class="carousel-caption text-center">
							<h3> invest your money
								<span>Want the best investment</span>
							</h3>
							<a href="shop.php" class="btn btn-sm animated-button gibson-three mt-4">Shop Now</a>
					...
					<div class="carousel-item item3">
						<div class="carousel-caption text-center">
							<h3>Competent members 
								<span>Get a team that meets your needs</span>
							</h3>
							<a href="shop.php" class="btn btn-sm animated-button gibson-three mt-4">Shop Now</a>
					...
					<div class="carousel-item item4">
						<div class="carousel-caption text-center">
							<h3>Best projects ideas
								<span>Looking for a successful business idea?</span>
							</h3>
							<a href="shop.php" class="btn btn-sm animated-button gibson-three mt-4">Shop Now</a>
						</div>
					</div>
						...
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item ">
									<img    style="height:250px"  class="img-fluid  " src="projects/<?php echo($row["project_id"]); ?>.jpg" class="img-fluid" alt="">
									...
									<?php     
									if ($row["states"]=="taken"){  ?>
													<span class="product-new-top">taken</span>
				...
				<div class="row">
					<div class="col-md-12 middle-slider my-4">
						<div class="middle-text-info ">
							...
							<h3 class="tittle-w3layouts two text-center my-lg-4 mt-3">New Year Flash sale</h3>
